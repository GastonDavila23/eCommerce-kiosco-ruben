...
export default function QRGenerator() {
    ...
    return (
        <div className="p-8 bg-[#111] rounded-[2.5rem] text-black flex flex-col items-center gap-6 shadow-sm">

            <div className="flex flex-col items-center gap-1">
                <h3 className="text-[16px] font-black uppercase tracking-[0.3em] text-orange-500">Tu Carta Digital</h3>
            </div>
